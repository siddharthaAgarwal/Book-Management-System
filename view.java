...
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    ...
    public String[][] combArray()
    {
        ...
        try {
            ...
            ResultSet rs=db.fetch("Select * from books");
            
            try {
                while(rs.next())
                {
                    arr.add(new String[] {rs.getString(1),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getInt(6)+" ",rs.getInt(7)+" "});
                }
    ...
    private void initComponents() {
        ...
        stockTable.setModel(new javax.swing.table.DefaultTableModel(
                this.combArray(),
            new String [] {
                "ISBN", "Title", "Author", "Country","Stock","Price"
            }
        ));
